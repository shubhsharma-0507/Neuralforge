...
//                     <div className="flex items-center justify-between px-3 py-2 bg-background/50 rounded-t-lg border-b border-border/50">
...
//                       </button>
//                     </div>
//                     <pre className="p-3 bg-background/50 rounded-b-lg overflow-x-auto">
...
//     {isBot && i === message.content.split('```').length - 1 && (
//       <span className="animate-pulse ml-1 inline-block">
//         |
//       </span>
//     )}
//   </span>
...
//       th({ children }) {
//         return (
//           <th className="border border-border px-4 py-2 bg-secondary text-left">
//             {children}
//           </th>
//         )
//       },
...
//             <Button className="bg-gradient-to-r from-blue-500 to-cyan-500 text-white border-0">
...
//                 />
//                 <Button size="icon"  onClick={sendMessage} className="rounded-xl bg-gradient-to-r from-blue-500 to-cyan-500">
