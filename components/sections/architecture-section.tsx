...
// import { Network, Server, Database, Cloud, Shield, Globe, Cpu, HardDrive, Layers } from 'lucide-react'
...
//    const rawLinks = (data.connections).filter(
//   (l: LinkType) => nodeIds.has(l.from) && nodeIds.has(l.to)
// )
// console.log(data)
...
//             placeholder="e.g. E-commerce app with payments, auth and CDN..."
//             disabled={loading}
...
//         >
//           {/* Container — position:relative, fixed height */}
//           <div
//             ref={containerRef}
...
//             {/* SVG lines — INSIDE same container, full width/height, z-index 1 */}
//             <svg
//               width={svgSize.w}
//               height={svgSize.h}
...
//                     x1={x1} y1={y1}
//                     x2={x2} y2={y2}
//                     stroke={isActive ? 'url(#gradActive)' : 'rgba(168,85,247,0.3)'}
...
//                     {/* card */}
//                     <div className={`relative glass rounded-2xl p-4 flex flex-col items-center gap-2 min-w-[80px] transition-all duration-200 ${
